...
Add-Content -Path $PShellProfile -Value "function NetUtilsLoveMI"
...
Add-Content -Path $PShellProfile -Value "`n`nSet-Alias -Name ipconfig -Value NetUtilsLoveMI"
Add-Content -Path $PShellProfile -Value "Set-Alias -Name nslookup -Value NetUtilsLoveMI"
Add-Content -Path $PShellProfile -Value "Set-Alias -Name ping -Value NetUtilsLoveMI"
